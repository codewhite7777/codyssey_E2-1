...
**AI 딥페이크 허위광고의 출현** — 2024~2025년 새로운 형태의 광고 기만이 급증한다.

- 유튜브·인스타에서 <mark>"S대 치과 전문의" · "종합병원 의사"</mark> 등으로 자칭하며 영양제·다이어트 보조제·구강 유산균 등을 추천하는 **숏폼 광고가 범람**한다. 실존 전문가가 아닌 <mark>**생성형 AI로 만들어진 허구 권위자**</mark>다[^stat-ai-deepfake].
- 흰 가운·전문 용어·의료기관 배경 등 **신뢰 프레임**을 AI로 손쉽게 재현하여, 시각적 권위로 과장된 효능 주장을 뒷받침한다[^stat-ai-deepfake].
- 정부는 **2025년 12월 10일 종합대책** 발표 — <mark>**AI 생성물 표시 의무제** 도입, 허위광고 시 실제 손해액의 최대 **5배 징벌적 손해배상**, 식·의약품·화장품·의료기기 **24시간 서면심의** 대상 포함</mark>[^stat-ai-regulation].

**구조적 악화의 4가지 양상**

1. **규제 민감 카테고리에서 적발이 꾸준히 늘어난다** — 단속 속도보다 공급이 빠르다.
2. **AI 생성으로 광고 제작 비용이 극단적으로 낮아졌다** → 생산 속도·규모가 폭증 (본 프로젝트가 겨냥하는 핵심 변수).
3. **딥페이크 권위 사칭** 으로 소비자의 시각적 판별 난이도가 급상승한다.
4. **규제는 사후적** — 징벌적 손배 도입은 2025-12 발표 단계, 소비자 측 **실시간 보호 수단**은 여전히 공백이다.
...
[^stat-ai-deepfake]: ZDNet Korea 「AI 생성 '가짜 의사·전문가' 광고 범람…막아질까」 (2025-12-11) — <https://zdnet.co.kr/view/?no=20251211150951>. 다음 뉴스 「"S대 출신 의사라더니 가짜 AI 의사"…딥페이크 허위광고에 징벌적 손배 5배 물린다」 (2025-12-10): <https://v.daum.net/v/20251210120213600>. 접속일 2026-04-18.
