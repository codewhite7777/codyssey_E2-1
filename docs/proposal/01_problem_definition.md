...
> 🔎 **상세 레퍼런스** — 거래 주체별·채널별 전체 분류, 가치사슬 11개 레이어(L1 소싱~L11 재구매) 상세 정의, 이해관계자 × 레이어 페인포인트 매트릭스는 [`docs/research/01_domain_definition.md`](../research/01_domain_definition.md) 에 정리되어 있다.
>
> 본 프로젝트가 이 가치사슬 중 **어느 레이어에 개입하는지**는 §1.4.1 개입 좌표 시각화에서 다룬다.

### 1.1.1 이커머스 시장 규모 — 6년간 2배 성장

![국내 온라인쇼핑 연간 거래액 추이 2019-2025](../../assets/diagrams/ecommerce_growth.png)

<sub>생성 스크립트: [`scripts/make_ecommerce_growth.py`](../../scripts/make_ecommerce_growth.py)</sub>
...
### 1.1.2 광고 채널의 시대적 진화 — 포털 → 모바일 → 숏폼·AI

국내 디지털 광고 채널은 약 30년간 네 단계로 진화해왔다. 각 전환의 공통 동인은 **사용자 체류 시간의 이동**이다.

```mermaid
timeline
    title 국내 이커머스 광고 채널의 진화
    section 포털·검색광고 1997~2000년대 중반
        1997 : 국내 인터넷 광고 210억 원 규모
        2000 : 1360억 원으로 6배 성장 (배너+CPC 검색)
    section 소셜미디어·UCC 2001~2010
        2001 : 싸이월드 미니홈피 — 소셜 광고 시초
        2003 : 네이버 블로그·카페 — 커뮤니티 마케팅
        2008 이후 : 페이스북·파워블로거 마케팅 확산
    section 모바일 피드 2010~2019
        2010 이후 : 스마트폰 보급, 모바일 광고 급증
        2012 이후 : 네이버 디스플레이 감소, 모바일 광고가 대체
        2014 이후 : 페이스북·인스타 피드 네이티브 광고 주류화
    section 숏폼·AI 시대 2020~
        2020~2021 : COVID-19 + 라이브커머스 급성장
        2022 이후 : YouTube Shorts·Reels·TikTok 주류화
        2024 이후 : 생성형 AI 광고 대량 생산
```

**각 전환의 본질**

| 단계 | 사용자 행동 | 광고 형식 | 공급 측 변화 |
|------|-------------|-----------|--------------|
| 포털 | 의도 검색 (내가 찾는다) | 배너 · 검색결과 링크 | CPC 경매 입찰 |
| 소셜·UCC | 관계·콘텐츠 탐색 | 블로그·커뮤니티 후기 | 인플루언서 섭외 |
| 모바일 피드 | 무한 스크롤 | 피드 네이티브 광고 | 타겟팅 정교화 |
| **숏폼·AI** | **알고리즘 주도 자동 피드** | **15~60초 영상 · 네이티브 인스트림** | <mark>**AI 생성으로 극단적 비용 절감**</mark> |
...
### 1.1.3 숏폼 동영상 — 이커머스 광고의 주력 소비 형태
- YouTube Shorts · Instagram Reels · TikTok 등 **15~60초 세로형 동영상** 포맷이 2020년 전후 대중화기를 지나 주류화되었다.
- 컨슈머인사이트 2025년 이동통신 기획조사에 따르면 <mark>국내 이용자는 숏폼을 한 번 보기 시작하면 평균 21분간 연속 시청</mark>하며, 스마트폰·태블릿 영상 시청의 주요 형태가 되었다 (하루 평균 97분)[^stat-shortform].
