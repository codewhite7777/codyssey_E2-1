...
> 🖼️ **이미지 삽입 자리** — 실제 사례 스크린샷 또는 직접 제작한 참고 이미지를 이 위치에 배치할 수 있다.
>
> **사용 가능한 소스**
> - 언론 보도 기사 내 캡처 (※ 출처 명시 · 공정이용 범위 준수)
> - 직접 수집한 숏폼 광고 프레임 (발표용 범위 내 사용)
> - 팀 자체 제작 일러스트
>
> **삽입 방법** — 이미지 파일(예: `deepfake_reference.png`)을 `assets/diagrams/` 에 저장한 뒤, 이 블록쿼트를 아래 한 줄로 교체.
> ```markdown
> ![AI 딥페이크 광고 예시](../../assets/diagrams/deepfake_reference.png)
> ```
