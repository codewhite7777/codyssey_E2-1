...
본 프로젝트는 이커머스 가치사슬 11개 레이어 중 <mark>**L4 광고·마케팅**</mark>에서 유통되는 허위·과장 광고를 포착하고, <mark>**L6 의사결정 지원**</mark> 지점에서 소비자에게 판별 근거를 제공한다. 즉 **공급 측(광고)의 콘텐츠를 분석**해 **수요 측(소비자)의 판단**을 돕는 이중 개입 구조다.
