...
- **AI 딥페이크 가짜 전문가 광고 범람** — 한국경제 2025-12-10 보도 기준 <mark>"S대 치과 전문의" 송 모 씨</mark>가 "흔들리는 치아, 치과 오지 마세요. 이것만 해도 꽉 잡힙니다"며 **구강 유산균**을 추천하는 숏폼 광고가 유튜브·SNS에 범람, **실존 인물이 아닌 AI 생성 허구 권위자**로 밝혀졌다[^stat-ai-deepfake]. 본 기획서 **§1.1.4 에서 실제 4건의 사례 스크린샷**으로 공통 패턴(권위 자칭·의료 스튜디오·구체 효능·취약층 겨냥) 확인.
- **정부 공식 위험도 인정 (2025-12-10)** — 방송미디어통신위원회 등 관계부처 합동 「AI 신기술 활용 거래질서 교란 행위 대응책」 발표 — <mark>**AI 생성물 표시 의무제 + 5배 징벌적 손해배상 + 24시간 서면심의**</mark>[^stat-ai-regulation]. 정책브리핑 원문: <https://www.korea.kr/news/policyNewsView.do?newsId=148956230>.
...
<sub>생성 스크립트: [`scripts/make_selection_reasons.py`](../../scripts/make_selection_reasons.py) — `uv run scripts/make_selection_reasons.py` 로 재생성 가능</sub>
...
| **규제기관** (공정위·식약처·방미통위) | **광고 모니터링 자동화** — 서면심의 24시간 체계 보완 |
| **정직한 셀러** | 공정경쟁 회복 — 거짓 광고로 비교우위 잃는 피해 완화 |
...
- **데모 임팩트**: 앱·브라우저 확장 프로토타입 형태로 **발표 시 바로 시연 가능**. "의심 영상 공유 → 즉시 리포트" 플로우가 청중의 공감을 직관적으로 확보한다.
