...
![AI 딥페이크 숏폼 광고의 전형적 패턴 — 4가지 red flag](../../assets/diagrams/deepfake_example.png)

<sub>생성 스크립트: [`scripts/make_deepfake_example.py`](../../scripts/make_deepfake_example.py). 저작권 보호를 위해 실제 스크린샷이 아닌 **재현 mockup**을 사용한다.</sub>
